...
class _RidePrefFormState extends State<RidePrefForm> {
  ...
  void onDepartureSelected(Location location) {
    setState(() {
      departure = location;
    });
  }

  void onArrivalSelected(Location location) {
    setState(() {
      arrival = location;
    });
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        // Arrival Location
          RidePrefList(
              icon: Icons.radio_button_unchecked,
              text: arrivalLabel,  // Using getter
              onTap: () => {},
            ),
            const SizedBox(height: BlaSpacings.s),
            BlaDivider(),
           ...
           RidePrefList(
            ...
            // Number of Seats
            RidePrefList(
              icon: Icons.person_2_outlined,  // Use 'icon' instead of 'leftIcon' for consistency
              text: numberLabel,
              onTap: () => {},
            ),
            const SizedBox(height: BlaSpacings.s),
